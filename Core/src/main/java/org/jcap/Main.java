...
public class Main {
    public static void main(String[] args) {
        ...
        for(JpCapNetworkInterface intf:list) {
           ...
           System.out.println("Description: " + (intf.description != null ? intf.description : "No description available"));
           ...
           for(JpCapAddress add:address) {
               ...
               // if(sa.sa_family==Inets.AF_INET) a = new JpCapIPv4Address(address,sa.sa_family,"Ankit");
