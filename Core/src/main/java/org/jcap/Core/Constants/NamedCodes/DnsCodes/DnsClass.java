...
public class DnsClass extends NamedCode<Short,DnsClass> {
     ...
     * <p>
     * This class is obsolete and was used historically for the CSNET network, a part of the early Internet. It is maintained
     * in modern DNS specifications only for backward compatibility with older systems and is referenced in examples found
     * in some obsolete RFCs. This class is no longer used in practice and should generally be avoided in new DNS-related
